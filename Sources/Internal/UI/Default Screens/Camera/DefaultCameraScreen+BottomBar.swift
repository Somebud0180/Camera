...
private extension DefaultCameraScreen.BottomBar {
    var isOutputTypeSwitchActive: Bool { parent.config.cameraOutputSwitchAllowed && parent.cameraManager.attributes.isOutputTypeSwitchActive && parent.cameraManager.captureSession.isRunning && !parent.isRecording }
